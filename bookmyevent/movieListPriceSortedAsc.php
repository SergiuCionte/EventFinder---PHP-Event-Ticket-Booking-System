 ...
 <div class="container" style="border:1px solid red;">
  <div>
    ...
    <br>
          <?php 
          $count=0;
      //selectez toate evenimentele ordonate crescator dupa pret
  
          $res=$conn->query("select * from eventlist order by price;");
          echo "<div class='row'>";
          ...
          while ($row=$res->fetch_object()) {
            ...
            //afisez toate detaliile fiecarui eveniment
            echo " 
            <div class='col-md-3'>
