...
<head>
 ...
 <!-- pagina principala unde se afiseaza diferite mesaje de bun venit -->
</head>
<body style="background-image: url('images/bg.jpg');background-size:100%;">
  ...
  <div id="bg_index" style="height:800px" class="center title">
    <h1 style="font-size:80px;">Welcome to EventFinder</h1>
      ...
      <div class="modal-dialog login animated">
        <div class="modal-content">
          ...
          <div class="modal-body">  
            ...
            <!-- Se realizeaza logarea, iar daca nu exista cont se poate crea unul -->
